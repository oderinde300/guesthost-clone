...
import RentalCarSearchForm from "../(client-components)/(HeroSearchForm)/(car-search-form)/RentalCarSearchForm";
...
const SectionHero3: FC<SectionHero3Props> = ({ className = "" }) => {
  return (
    ...
    <div className="h-screen w-full bg-home-1 bg-cover flex justify-center items-center">
      <div
